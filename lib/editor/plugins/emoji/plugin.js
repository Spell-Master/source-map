                            ...
                            listener: function (event) {
                                if (event.data.getTarget().data('cke-emoji-name')) {
                                    this.editor.execCommand('insertEmoji', {
                                        ...
                                        emojiName: event.data.getTarget().data('cke-emoji-full-name')
                                    });
                                }
                            }
                        });
                ...
                exec: function (editor, data) {
                    editor.insertHtml('\
                        <img\n\
                            ...
                            width:35px;\n\
                            margin:0;\n\
                            padding:0;" alt="' + data.emojiText + '">');
                    console.log(data.emojiName)
                }
                //allowedContent: 'img(emoji-item)'
                /*
                    var emojiName = data.emojiName;
                    var imgA = emojiName.substr(0, (emojiName.length - 1));
                    var imgB = imgA.substr(1);
                    var imgSrc = 'lib/images/emoji/' + imgB + '.png';
                    editor.insertHtml('\
                        <img\n\
                            src="'+ imgSrc + '"\n\
                            style="font-size:35px;\n\
