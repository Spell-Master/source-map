...
(function () {
    ...
    CKEDITOR.plugins.add('font', {
        ...
        init: function (editor) {
            var config = editor.config;
            //addCombo(editor, 'Font', 'family', {}, config.font_names, config.font_defaultLabel, config.font_style, 30);
            addCombo(editor, 'FontSize', 'size', {}, config.fontSize_sizes, config.fontSize_defaultLabel, config.fontSize_style, 40);
        }
    });
})();
