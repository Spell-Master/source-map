...
CKEDITOR.plugins.add('colorbutton', {
    ...
    init: function (editor) {
        ...
        if (!CKEDITOR.env.hc) {
            addButton('TextColor', 'fore', 'Cor do Texto', 10, {
            ...
            addButton('BGColor', 'back', 'Cor do Plano de Fundo', 20, bgOptions);
        }
        ...
        function addButton(name, type, title, order, options) {
            ...
            editor.ui.add(name, CKEDITOR.UI_PANELBUTTON, {
                ...
                panel: {
                    ...
                    attributes: {role: 'listbox', 'aria-label': 'Cores'}
                },
        ...
        function renderColors(panel, type, colorBoxId, colorData) {
            ...
            if (config.colorButton_enableAutomatic !== false) {
                ...
                output.push('<a class="cke_colorauto" _cke_focus=1 hidefocus=true' +
                        ...
                        ' href="javascript:void(\'Automático\')"' +
                        ' role="option" aria-posinset="1" aria-setsize="', total, '">' +
                        '<table role="presentation" cellspacing=0 cellpadding=0 width="100%">' +
                        '<tr>' +
                        '<td colspan="' + colorsPerRow + '" align="center"><span class="cke_colorbox" id="', colorBoxId, '"></span>', 'Automático', '</td>' +
                        '</tr>' +
                        '</table>' +
                        '</a>');
            }
            ...
            if (moreColorsEnabled) {
                output.push('</tr>' +
                        ...
                        ' href="javascript:void(\'Mais Cores...\')"', ' role="option" aria-posinset="', total, '" aria-setsize="', total, '">Mais Cores...</a>' +
...
CKEDITOR.config.colorButton_colors =
        '404040,000000,f44336,c40700,3b9900,2f7a00,3b7fe7,0051b4,' +
        'ff01ff,b100b1,8e28a3,6b1e7a,324299,263172,00ffff,009999,' +
        'f4cca4,efb275,ffd400,ccaa00,ff7f00,cc6600,9f705f,5f4339';
