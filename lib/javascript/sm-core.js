...
(function () {
    ...
    smcore = (function () {
        ...
        var topScroll = function () {
            var $scrollY = 0, $headerB = document.getElementById('header-bottom');
            var $topButton = document.getElementById('scoll-top');

            $topButton.addEventListener('click', smlib.scrollTop, false);
            document.addEventListener('scroll', function (e) {
                $scrollY = window.scrollY;
                if (smlib.isReady($headerB)) {
                    if ($scrollY > 50) {
                        $headerB.classList.add('top');
                    } else {
                        $headerB.classList.remove('top');
                    }
                }
                if ($scrollY > 200) {
        ...
        var modalControl = {
            ...
            saveform: function (form, file, windowTitle, open) {
                ...
                return (smlib.ajax.formSend(form, 'modal-load', 'modules/actions/' + file));
            },
        ...
        var formItens = {
            ...
            save: function (form, div, file) {
                return (smlib.ajax.form(form, div, 'modules/actions/' + file));
            }
        };
