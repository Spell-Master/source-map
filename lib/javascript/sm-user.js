...
(function () {
    ...
    smUser = (function () {
        ...
        var login = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.formItens.save('user-login', 'modal-load', 'user.php');
                }
            } catch (e) {
         ...
         */
        var logOut = function () {
            smCore.modal.ajax('modules/actions/user/logout.php', 'Saíndo', false);
        };
        ...
        var pass = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.modal.alertAction('recover-pass', 'user.php', 'Redefinir Senha');
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
        ...
        var confirm = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.modal.saveform('confirm-new', 'user.php', 'Validar Cadastro', true);
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
        ...
        var reMail = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.modal.saveform('re-mail', 'user.php', 'Enviar E-Mail', true);
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
        ...
        function register(len) {
            ...
            try {
                if (!$name) {
                    ...
                    smCore.modal.saveform('new-user', 'user.php', 'Novo Cadastro', true);
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
