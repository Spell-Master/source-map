        ...
        var login = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.formItens.save('user-login', 'modal-load', 'user/login.php');
                }
            } catch (e) {
        ...
        var pass = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.modal.alertAction('recover-pass', 'user/recover-pass.php', 'Redefinir Senha');
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
        ...
        var confirm = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.modal.saveform('confirm-new', 'user/new-confirm.php', 'Validar Cadastro', true);
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
        ...
        var reMail = function (len) {
            ...
            try {
                if (!$mail) {
                    ...
                    smCore.modal.saveform('re-mail', 'user/re-mail.php', 'Enviar E-Mail', true);
                }
            } catch (e) {
                smCore.modal.error(e, true);
            }
