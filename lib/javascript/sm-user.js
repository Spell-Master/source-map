    ...
    smUser = (function () {
        ...
        var uploadFile = function (maxSize) {
            ...
            function fileData(e) {
                ...
                try {
                    if ($file.size >= maxSize) {
                        throw 'Você só pode enviar arquivos menores que: ' + maxSize;
                    } else if ($isImg && ($ext != 'jpg' && $ext != 'jpeg' && $ext != 'pjpeg' && $ext != 'png' && $ext != 'x-png')) {
                        throw 'Você só pode enviar imagens .PNG, ou .JPG';
                    } else {
                        $name.innerText = $file.name;
                        $submit = document.createElement('button');
                        $submit.className = 'btn-info text-white';
                        $submit.innerHTML = 'Transferir Arquivo <i class="icon-upload"></i>';
                        $submit.type = 'button';
            ...
            function sendFile(e) {
                ...
                smTools.transfer.upload($form.id, 'modules/actions/user/upload-' + ($isImg ? 'image' : 'file') + '_v.php', 'upload-status', true);
            }
        };
