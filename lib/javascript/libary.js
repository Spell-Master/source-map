...
// ShoppingCart V1.0 (2021)
var ShoppingCart=function(e){var t,n=document.getElementById("shopping-cart"),a={text:n.querySelector('[data-cart=""]'),form:n.getElementsByTagName("form")[0],target:null,count:0};function c(e){var t,c;a.target=e.target,a.target.checked?(a.count++,(c=document.createElement("input")).type="hidden",c.name=a.target.name,c.value=a.target.value,a.form.appendChild(c)):(a.count--,t=a.form.querySelector('input[value="'+a.target.value+'"]'),a.form.removeChild(t)),function(){a.count>=1?n.classList.add("opened"):n.classList.remove("opened");a.text.innerText=a.count>=1?"Selecionados ("+a.count+")":null}()}if(this.addInput=function(e){"checkbox"!==e.type||e.classList.contains("cart-add")||(e.checked&&(e.checked=null),e.classList.add("cart-add"),e.addEventListener("change",c,!1))},e){t=document.getElementsByClassName(e);for(var o=0;o<t.length;o++)this.addInput(t[o])}};
