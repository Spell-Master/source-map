...
(function () {
    ...
    smTools = (function () {
        ...
        var shoppingCart = {
            init: function (input) {
                shoppingCart.prototype = new ShoppingCart((input ? input : false));
            }, add: function (input) {
                if (!check.isReady(shoppingCart.prototype)) {
                    shoppingCart.prototype = new ShoppingCart(false);
                }
                shoppingCart.prototype.addInput(input);
            }, restart: function () {
                if (!check.isReady(shoppingCart.prototype)) {
                    shoppingCart.prototype = new ShoppingCart(false);
                }
                shoppingCart.prototype.restart();
            }
        };
