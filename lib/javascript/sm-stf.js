    ...
    smStf = (function () {
        ...
        var doc = {
            addSector: function () {
                smTools.scroll.top();
                document.getElementById('paginator').classList.add('hide');
                smTools.ajax.send('page-action', 'modules/admin/doc/sector-new.php', false);
            },
            addCateg: function () {
                smTools.scroll.top();
                document.getElementById('paginator').classList.add('hide');
            ...
            editSector: function (hash) {
                smTools.scroll.top();
                document.getElementById('paginator').classList.add('hide');
                smTools.ajax.send('page-action', 'modules/admin/doc/sector-edit.php?hash=' + hash, false);
            },
            delCateg: function (hash) {
                smCore.modal.dangerAction('del-' + hash, 'admin/doc/categ-del_v.php', 'Apagar');
            },
            delSector: function (hash) {
                smCore.modal.dangerAction('del-' + hash, 'admin/doc/sector-del_v.php', 'Apagar');
            },
            filterSector: function (filter) {
                smTools.scroll.top();
                document.getElementById('page-action').innerHTML = null;
                document.getElementById('page-preview').innerHTML = null;
                document.getElementById('paginator').classList.remove('hide');
                smTools.ajax.send('paginator', 'modules/admin/doc/sector-paginator.php?filter=' + filter);
            },
