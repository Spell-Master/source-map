    ...
    smStf = (function () {
        ...
        var app = {
            searchPage: function (len) {
                ...
                try {
                    if (!$search) {
                        ...
                        smCore.modal.saveform('search-app', 'admin/app-search.php', 'Pesquisar', true);
                    }
                } catch (e) {
            ...
            delPage: function (hashId) {
                smCore.modal.dangerAction('del-' + hashId, 'admin/app-del.php', 'Apagar Página');
            },
            ...
            previewPage: function (type) {
                ...
                if (smTools.check.isReady($editor) && $editor.length >= 1) {
                    ...
                    smTools.ajax.formSend(type + '-app', 'page-preview', 'modules/actions/admin/app-preview.php');
                } else {
            ...
            save: function (len, type) {
                ...
                try {
                    if (type !== 'new' && type !== 'edit') {
                        ...
                        smCore.modal.saveform(type + '-app', 'admin/app-' + type + '.php', (type == 'new' ? 'Nova' : 'Editar') + ' Página', true);
                    }
                } catch (e) {
                    smCore.modal.error(e, true);
                }
