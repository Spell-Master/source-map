    ...
    smStf = (function () {
        ...
        var doc = {
            ...
            secIcon: function (hash, maxSize) {
                ...
                $label.innerHTML = '<i class="icon-image4 icn-4x"></i><p class="bold">Clique para inserir uma imagem</p>(.jpg | .jpeg | .png | .svg)';
                ...
                function sendIcon(e) {
                    ...
                    try {
                        if ($file.size >= maxSize) {
                            throw 'A imagem é muito grande<p>Selecione uma imagem com menos de ' + maxSize + ' bits</p>';
                        } else if ($ext != 'jpg' && $ext != 'jpeg' && $ext != 'pjpeg' && $ext != 'png' && $ext != 'x-png') {
                            throw 'Em ícones de setores só poderemos usar imagem .PNG, ou .JPG</p>';
                        } else {
                            $erro.innerHTML = null;
...
//                    if ($file.size >= $size) {
//                    }  else {
//                        sm.transfer.upload('form-icon', 'modules/actions/admin/doc/sector_icon_v.php?hash=' + hash, 'icon-erro', true);
//                    }
//                }
            },
