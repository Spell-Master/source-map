    ...
    sm_e = (function () {
        ...
        var setOptions = function (options) {
            ...
            if (sml.isMobile()) {
                ...
                switch (options) {
                    case 'admin':
                        $newOptions = ['BulletedList', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'BlockQuote', 'LinkAdd', 'Spoiler'];
                        ...
                        break;
                    case 'advance':
                        $newOptions = ['BulletedList', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'Quote', 'LinkAdd', 'Spoiler'];
                        break;
                    case 'basic':
